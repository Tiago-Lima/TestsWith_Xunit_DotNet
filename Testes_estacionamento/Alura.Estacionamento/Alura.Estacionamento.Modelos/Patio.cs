...
namespace Alura.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        {
            var encontrado = (from veiculo in this.Veiculos where veiculo.Placa == placa select veiculo).SingleOrDefault(); // Recurso do LINK retorna um objeto de um array de objetos
